...
import { formatDate,showAlert } from "../utils/function";
...
const Repo = ({ repo }) => {
	...
	// 		toast.success('URL copied successfully!', { autoClose: 2000 });
	// 	} catch (error) {
	...
	const handleCloneClick = async (repo) => {
		try {
			await navigator.clipboard.writeText(repo.clone_url);
			showAlert('URL copied successfully!', 2000);
		} catch (error) {
			showAlert('Failed to copy URL!', 2000);
		}
	}
	return (
